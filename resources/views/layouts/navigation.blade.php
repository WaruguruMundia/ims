    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <button onclick="toggleDarkMode()" class="mr-4 p-2 rounded-full text-gray-550 hover:text-gray-700 hover:bg-gray-100 focus:outline-none transition" type="button" title="Toggle Dark/Light Mode">
                    ...
                    <svg class="w-5 h-5 block dark:hidden text-gray-550" fill="none" viewBox="0 0 24 24" stroke="currentColor">
