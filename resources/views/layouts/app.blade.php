    ...
    <head>
        ...
        <style>
            :root {
                ...
                --color-sidebar-bg: #1E3A8A; /* Deep Sapphire */
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 flex flex-col">
            ...
            <div class="flex-1 flex overflow-hidden">
                ...
                <aside id="sidebar-menu" class="w-64 bg-[#1E3A8A] text-white border-r border-slate-800 transition-all duration-300 flex flex-col shrink-0">
                    
                    <!-- Sidebar Header (IMS Logo Replacement) -->
                    <div class="flex justify-between items-center p-4 border-b border-slate-800 bg-[#1E3A8A]">
